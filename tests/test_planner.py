...
class TestExperimentDesigner:
    ...
    def designer(self, basic_experiment):
        ...
        return ExperimentDesigner(basic_experiment)
    ...
    def test_set_parameter_to_optimize_invalid_parameter(self, designer):
        ...
        with pytest.raises(ValueError, match="Parameter nonexistent_param not found in model parameters"):
...
class TestExptFromModelFile:
    ...
    def test_expt_from_model_file_with_reflectivity_data(self):
        ...
        experiment = expt_from_model_file(model_name, q_values, dq_values, reflectivity, errors)
        assert experiment is not None
